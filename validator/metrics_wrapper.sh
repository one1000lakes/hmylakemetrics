...
#Wrapper should be called like this: /data/hmylakemetrics/metrics_wrapper.sh -t MINUTEINTERVAL -p BASEPATH -s SHARDTHATNODESIGNS -r REMOTENODEADDRESS -h NODEHASH
